...
|-------|------|---------|-------------|
| `content.caption` | string | â€” | Caption below image |
| `content.alt` | string | â€” | Alt text for accessibility |
...
- `.image-framed` / `.image-fullbleed` / `.image-circular` â€” image presentation
